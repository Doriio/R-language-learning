...
# 绘制类别响应曲线 (CRCs) for each item
for (i in seq_along(data_efa2)) {
    plot(model_unconstrained, type = 'trace', item = i, main = paste("Category Response Curve for Item", colnames(data_efa2)[i]))
}
