...
#####验证性因素分析#####
# 检验正态性
mvn_test <- mvn(sample2[, c("1", "2", "3", "4", "5", "6", "7", "9", "10",
                            "12", "14", "15", "16", "17", "18", "19", "20")],
                mvnTest = "mardia")
...
# 3. 运行 CFA
# 使用 MLR 估计方法
cfa_result <- cfa(cfa_model, data = sample2, estimator = "WLSMV")
...
# 查看数据的分布
summary(sample2[, c("1", "2", "3", "4", "5", "6", "7", "9", "10",
                    "12", "14", "15", "16", "17", "18", "19", "20")])

# 检查异常值
boxplot(sample2[, c("1", "2", "3", "4", "5", "6", "7", "9", "10",
                    "12", "14", "15", "16", "17", "18", "19", "20")])