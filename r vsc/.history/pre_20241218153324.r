...
multi_loadings <- loadings_df %>%
  filter((abs(V1) > 0.40 & abs(V2) > 0.40 & abs(V1 - V2) < 0.2) |
         (abs(V1) > 0.40 & abs(V3) > 0.40 & abs(V1 - V3) < 0.2) |
         (abs(V2) > 0.40 & abs(V3) > 0.40 & abs(V2 - V3) < 0.2))
print(multi_loadings)
