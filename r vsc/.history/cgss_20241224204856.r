...
plot(model_unconstrained, type = "trace", which.items = 5, main = "Item 5")
plot(model_unconstrained, type = "trace", which.items = 7, main = "Item 7")
plot(model_unconstrained, type = "trace", which.items = 9, main = "Item 9")
plot(model_unconstrained, type = "trace", which.items = 11, main = "Item 11")
plot(model_unconstrained, type = "trace", which.items = 13, main = "Item 13")
plot(model_unconstrained, type = "trace", which.items = 15, main = "Item 15")
