...
##### EFA #####
# 定义响应列名，假设为 "l2501" 到 "l2515"
response_columns <- paste0("l250", 1:15)
# 提取EFA所需数据
data_efa <- data_filled[, response_columns]
# KMO检验
...
# 碎石图
scree(data_efa, factors = FALSE, pc = TRUE, main = "Scree Plot")

# 并行分析
fa_parallel <- fa.parallel(data_efa, fa = "fa", n.iter = 100, show.legend = FALSE, main = "Parallel Analysis")