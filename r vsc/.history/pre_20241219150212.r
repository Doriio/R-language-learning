...
cor_results <- data.frame(
  ...
  Correlation = c(cor_atop_dbs$estimate, cor_factor1_dbs$estimate, cor_factor2_dbs$estimate, cor_factor3_dbs),
  p_value = c(cor_atop_dbs$p.value, cor_factor1_dbs$p.value, cor_factor2_dbs$p.value, cor_factor2_dbs$p.value)
)
print(cor_results)
