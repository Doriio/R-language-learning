...
plot(model_unconstrained, type = "trace", which.items = 8, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 4, main = "Category Response Curve for item 1")
