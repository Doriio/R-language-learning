...
model_unconstrained <- mirt(data_efa2, model = 1, itemtype = "graded")
# 绘制7个条目的类别响应曲线（Category Response Curves）
plot(model_unconstrained, type = "trace", which.items = 3, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 5, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 1, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 9, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 11, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 13, main = "Category Response Curve for item 1")
plot(model_unconstrained, type = "trace", which.items = 15, main = "Category Response Curve for item 1")




# 绘制7个条目的项目信息曲线（Item Information Curves）
for (i in 1:7) {
  plot(model_unconstrained, type = "information", which.items = i, main = paste("Item Information Curve for item", i))
}