...
# 获取所有条目的项目信息
item_info_all <- iteminfo(model_unconstrained)

# 绘制每个条目的项目信息曲线（Item Information Curve, IIC）
for (i in 1:7) {
  plot(item_info_all[[i]], type = "l", main = paste("Item Information Curve for Item", i))
}
