...
##### DIF DTF #####
data_dif <- data_combined[, c("l2503", "l2505", "l2507", "l2509", "l2511", "l2513", "l2515", "")]

model_cfa <- mirt(data_combined, 1, itemtype = "graded")
# 定义grouping variable，假设性别为gender列，且已经是因子型数据
DIFanalysis <- difGM(model, group = data_combined$gender, anchor = c(1,2)) # anchor设置可根据需求调整
