...
# 第二次EFA
data_efa2 <- data_filled[, c("l2501", "l2502", "l2503", "l2505", "l2507", "l2508", "l2509", "l2510", "l2511", "l2512", "l2513", "l2515")]
# 进行并行分析
fa_parallel <- fa.parallel(data_efa2a, fa = "pc", n.iter = 100, show.legend = FALSE, main = "Parallel Analysis")
# 计算多项式相关矩阵
polychoric_corr2 <- polychoric(data_efa2)$rho
# 进行第一次探索性因子分析，使用多项式相关矩阵
efa_result2 <- fa(polychoric_corr2, nfactors = 2, fm = "pa", rotate = "varimax")
print(efa_result2)
fa_parallel <- fa.parallel(data_efa2, fa = "pc", n.iter = 100, show.legend = FALSE)