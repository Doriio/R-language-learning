...
plot(model_unconstrained, type = "trace", which.items = 1, main = "Category Response Curve for item 1")plot(model_unconstrained, type = "trace", which.items = 2)
plot(model_unconstrained, type = "trace", which.items = 1, main = "Category Response Curve for item 1")plot(model_unconstrained, type = "trace", which.items = 1)
plot(model_unconstrained, type = "trace", which.items = 1)
plot(model_unconstrained, type = "trace", which.items = 1)
plot(model_unconstrained, type = "trace", which.items = 1)
