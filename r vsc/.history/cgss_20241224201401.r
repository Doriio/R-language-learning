...
# 获取AIC和BIC
aic_unconstrained <- AIC(model_unconstrained)
bic_unconstrained <- BIC(model_unconstrained)
aic_constrained <- AIC(model_constrained)
bic_constrained <- BIC(model_constrained)
# 打印AIC和BIC值
cat("Unconstrained Model AIC:", aic_unconstrained, "\n")
cat("Unconstrained Model BIC:", bic_unconstrained, "\n")
cat("Constrained Model AIC:", aic_constrained, "\n")
cat("Constrained Model BIC:", bic_constrained, "\n")
