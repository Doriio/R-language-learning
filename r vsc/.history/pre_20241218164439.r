...
# 碎石图数据准备
fa_parallel <- fa.parallel(item_data_filtered, fa = "pc", n.iter = 100, show.legend = FALSE, main = "Scree Plot")
actual_values <- fa_parallel$values  # 实际特征值
simulated_values <- fa_parallel$fa.values  # 随机特征值
...
item_data_filtered <- item_data %>% select(-c("7", "12"))
