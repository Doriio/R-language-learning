...
# 多组
data_cfa <- data_combined[, c("l2503", "l2505", "l2507", "l2509", "l2511", "l2513", "l2515")]

model <- '
  F1 =~ l2503 + l2505 + l2507 + l2509 + l2511 + l2513 + l2515
'
# 拟合模型
fit <- cfa(model, data=data_combined)
summary(fit, fit.measures=TRUE)
# 性别分组的 MGCFA
fit_gender <- cfa(model, data=data_combined, group="gender")
summary(fit_gender, fit.measures=TRUE)
# 配置恒等性
configural_fit <- cfa(model, data=data_efa2, group="gender")
